...
func newSystemEventsCreateCmd(flags *rootFlags) *cobra.Command {
	var bodyPage int
	var bodyPerPage int
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Allow to query for a set of system events. Permission Required: View System Events.",
		Example:     " addigy-cli system-events create",
		Annotations: map[string]string{"pp:endpoint": "system-events.create", "pp:method": "POST", "pp:path": "/system-events/query"},
