...
func newMonitoringCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:         "create",
		Short:       "Create a monitoring item.",
		Example:     " addigy-cli monitoring create",
		Annotations: map[string]string{"pp:endpoint": "monitoring.create", "pp:method": "POST", "pp:path": "/monitoring"},
