...
func newMaintenanceUpdateStagedCmd(flags *rootFlags) *cobra.Command {
	var bodyDay string
	...
	cmd := &cobra.Command{
		Use:         "update-staged",
		Short:       "Updates a staged maintenance item.",
		Example:     " addigy-cli maintenance update-staged",
		Annotations: map[string]string{"pp:endpoint": "maintenance.update-staged", "pp:method": "PUT", "pp:path": "/maintenance/staged"},
